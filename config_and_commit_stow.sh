...
# -R (--restow) ensures it refreshes existing links and adds new ones.
# .stow-local-ignore in ~/dotfiles keeps archive-only content (README, LICENSE,
# backups, Library, Documents, etc.) from being symlinked into $HOME.
stow -R dotfiles
